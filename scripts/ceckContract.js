...
var fs = require('fs');
const getTransactionsByAccount = require('./getAllTransactions')
const addresses = [
  [
...
async function getTransactions() {
  try {
    ...
    for(let i = 0; i < addresses.length; i++) {
      ...
      console.log("Address: " + addresses[i][0] + " log data")
      fs.readFile(outputFilePath, 'utf-8', (err, data) => {
        ...
        try {
          ...
          const updatedData = existingData.concat(transactions);
      
          fs.writeFile(outputFilePath, JSON.stringify(updatedData, null, 2), (writeErr) => {
            if (writeErr) {
              console.error('Error writing to file:', writeErr);
            } else {
              console.log('New data appended to:', outputFilePath);
            }
          });
        } catch (parseErr) {
