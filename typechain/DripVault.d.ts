...
interface DripVaultInterface extends ethers.utils.Interface {
  functions: {
    ...
    "tokenUniswapV2Router()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "jpegTest", values?: undefined): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "tokenUniswapV2Router",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "jpegTest", data: BytesLike): Result;
...
export class DripVault extends BaseContract {
  ...
  functions: {
    ...
    buybackToken(overrides?: CallOverrides): Promise<[string]>;
    ...
    jpegTest(overrides?: CallOverrides): Promise<[string]>;
    ...
    tokenUniswapV2Router(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    buybackToken(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    jpegTest(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    tokenUniswapV2Router(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    buybackToken(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    jpegTest(overrides?: CallOverrides): Promise<PopulatedTransaction>;
